...
module.exports = {
	data: {
		...
		help: {
			helpCategories: ["Information","Entertainment","Server Only"],			shortDesc: "View the next number to count at",//Should be the same as the command setDescription field
