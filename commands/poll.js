...
module.exports = {
	data: {
		...
		help: {
			helpCategories: ["Entertainment","Server Only"],			shortDesc: "Make a poll with automatically tracked options",//Should be the same as the command setDescription field
