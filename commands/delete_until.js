...
const { ContextMenuCommandBuilder, InteractionContextType: IT, ApplicationIntegrationType: AT, ApplicationCommandType, ActionRowBuilder, ButtonBuilder, ButtonStyle, PermissionFlagsBits } = require("discord.js");
...
module.exports = {
    ...
    async onbutton(cmd, context) {
        ...
        const bulkMessageKey = cmd.customId.split("-").splice(1)
            .join("-");
