...
function getCommandPaths(cmds, includeAllModules) {
    ...
    if (includeAllModules) {
        const allModules = fs.readdirSync("./commands").filter(file => file.endsWith(".js"))
    ...
    data: {
        ...
        command: new SlashCommandBuilder()
            ...
            .addStringOption(option =>
                option.setName("command").setDescription("The command to block")
                    .setRequired(true)
                    .setAutocomplete(true)
            )
            .addBooleanOption(option =>
                option.setName("unblock").setDescription("Unblock this command instead?")
                    .setRequired(false)
            )
            .addBooleanOption(option =>
