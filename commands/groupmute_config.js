...
module.exports = {
	data: {
		...
		help: {
			helpCategories: ["Administration","Configuration","Server Only","Entertainment"],			shortDesc: "Configure the ability for server members to vote to mute someone",//Should be the same as the command setDescription field
