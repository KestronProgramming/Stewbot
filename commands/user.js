...
module.exports = {
	data: {
		...
		help: {
			helpCategories: ["General","Information","Administration","Entertainment"],			shortDesc: "Display a user's profile",//Should be the same as the command setDescription field
