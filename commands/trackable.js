...
module.exports = {
    ...
    data: {
        command: new SlashCommandBuilder()
            ...
            .setName("trackable")
            .setDescription("Manage trackables")
            .addSubcommand(command => command.setName("about").setDescription("Learn more about trackables")
            ...
            .addSubcommand(command => command.setName("create").setDescription("Create your trackable. This will open an editor.")
                .addAttachmentOption(option =>
                    option.setName("image").setDescription("The image that you want to make into a trackable")
                        .setRequired(true)
                )
            )
            ...
            .addSubcommand(command =>
                command.setName("stats").setDescription("View a trackable with its ID")
                    .addStringOption(option =>
                        option.setName("id").setDescription("The ID of the trackable you want to view")
                            .setRequired(false)
                    )
                    .addBooleanOption(option =>
                        option.setName("private").setDescription("Make the response ephemeral?")
