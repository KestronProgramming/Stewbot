...
const { Events, SlashCommandBuilder, ActionRowBuilder, PermissionFlagsBits, RoleSelectMenuBuilder } = require("discord.js");
...
module.exports = {
    data: {
        // Slash command data
        command: new SlashCommandBuilder().setName("auto-join-roles")
            .setDescription("Automatically add roles to a user when they join the server")
