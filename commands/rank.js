...
module.exports = {
	...
	data: {
		...
		requiredGlobals: [],
        help:{
            helpCategories: ["Information","General","Entertainment","Server Only"],			shortDesc: "View someone's rank for this server's level ups",//Should be the same as the command setDescription field
