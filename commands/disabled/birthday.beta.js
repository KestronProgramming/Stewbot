...
module.exports = {
    data: {
        command: new SlashCommandBuilder().setName("birthday")
            .setDescription("Configure different birthday stuff")
            .addSubcommand(command =>
                command.setName("set_birthday").setDescription("Set your birth month and day")
                    .addIntegerOption(option =>
                        option.setName("birthday").setDescription("Set your birthday")
                            .setMinValue(1)
                            .setMaxValue(31)
                    )
                    .addIntegerOption(option =>
                        option.setName("birthmonth").setDescription("Set your birthmonth")
                            .setChoices(
                    ...
                    .addIntegerOption(option =>
                        option.setName("birthyear").setDescription("Set your birthyear")
                            .setMinValue(new Date().getFullYear() - 120)
                            .setRequired(false)
                    )
            ...
            .addSubcommand(command =>
                command.setName("change_publicity").setDescription("Change the publicity of your birthday")
                    .addStringOption(option =>
                        option.setName("global").setDescription("Set your publicity for this server or for all servers?")
                            .addChoices(
                    ...
                    .addBooleanOption(option =>
                        option.setName("birthday").setDescription("Should your birthmonth and day be publicized?")
                            .setRequired(true)
                    )
                    .addBooleanOption(option =>
                        option.setName("birthyear").setDescription("Should your birthyear be publicized?")
                            .setRequired(true)
                    )
                    .addBooleanOption(option =>
        ...
        switch (cmd.options.getSubcommand()) {
            ...
            case "change_publicity":
                if (cmd.options.getBoolean("delete_all")) {
                    cmd.followUp({ content: `# ⚠️ Are you sure?\nThis will delete your birthday across ALL of Stewbot.`, components: [new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId(`birthday-delete-${cmd.user.id}`)
                        .setLabel("Yes")
                        .setStyle(ButtonStyle.Danger))], ephemeral: true });
                    break;
                }
