...
module.exports = {
    data: {
        command: new SlashCommandBuilder().setName("pin")
            .setDescription("Allow users to pin messages without giving them deletion permissions")
            ...
            .addSubcommand(command =>
                command.setName("add").setDescription("Pin a message")
                    .addStringOption(option =>
                        option.setName("message").setDescription("The ID or link to the message")
                            .setRequired(true)
                    )
                    .addBooleanOption(option =>
                        option.setName("private").setDescription("Make the response ephemeral?")
            ...
            .addSubcommand(command =>
                command.setName("remove").setDescription("Unpin a message")
                    .addStringOption(option =>
                        option.setName("message").setDescription("The ID or link to the message")
                            .setRequired(true)
                    )
