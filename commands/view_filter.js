...
module.exports = {
	data: {
		...
		help: {
			helpCategories: ["Information","Server Only"],			shortDesc: "View the list of blacklisted words for this server",//Should be the same as the command setDescription field
