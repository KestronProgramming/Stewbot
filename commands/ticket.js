...
module.exports = {
	data: {
		...
		help: {
			helpCategories: ["Administration","Configuration","Server Only"],			shortDesc: "Set up a ticket system here for users to contact mods",//Should be the same as the command setDescription field
